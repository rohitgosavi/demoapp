...
import com.demo.application.DemoappApp;

import com.demo.application.domain.Customer;
import com.demo.application.repository.CustomerRepository;
...
public class CustomerResourceIntTest {
    ...
    public void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getCustomerContact()).isEqualTo(DEFAULT_CUSTOMER_CONTACT);
    }
    ...
    public void getAllCustomers() throws Exception {
        ...
        restCustomerMockMvc.perform(get("/api/customers?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].customerContact").value(hasItem(DEFAULT_CUSTOMER_CONTACT.toString())));
    }
    ...
    public void getCustomer() throws Exception {
        ...
        restCustomerMockMvc.perform(get("/api/customers/{id}", customer.getId()))
            ...
            .andExpect(jsonPath("$.customerContact").value(DEFAULT_CUSTOMER_CONTACT.toString()));
    }
    ...
    public void updateCustomer() throws Exception {
        ...
        assertThat(testCustomer.getCustomerContact()).isEqualTo(UPDATED_CUSTOMER_CONTACT);
    }
